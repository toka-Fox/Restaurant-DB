...
def init_restaurantdb():
    try:
        ...
        tables = {
            ...
            "Ingredient": "CREATE TABLE IF NOT EXISTS Ingredient (ingredient_id INT AUTO_INCREMENT PRIMARY KEY, ingredient_name VARCHAR(60), ingredient_unit VARCHAR(20), ingredient_current_qty DECIMAL(10,2), ingredient_reorder_level DECIMAL(10,2))",
